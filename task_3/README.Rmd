...
![Vista en Leaflet Departamento del Norte de Santander](views/Maps/Rmd/1.png){#id .class width=70% height=70%}

</center>

<center>

![Vista en Leaflet ciudad de Cúcuta](views/Maps/Rmd/2.png){#id .class width=70% height=70%}
...
![Gráfica Departamento Norte de Santander](views/Maps/Rmd/3.png){#id .class width=70% height=70%}
...
![Coeficientes de Variable Categórica de Municipio](views/Reg/Cod_mpio.jpeg){#id .class width=70% height=70%}
...
![Coeficientes de Variable Categórica de Años](views/Reg/Years.jpeg){#id .class width=70% height=70%}
...
![Coeficientes de Variables Dummys](views/Reg/Dummys.jpeg){#id .class width=70% height=70%}
...
![Coeficientes de Variables Continuas de Distancias](views/Reg/Distance.jpeg){#id .class width=70% height=70%}
...
![Coeficientes de todas las Regresiones](views/Reg/margins_plot.jpeg){#id .class width=70% height=70%}
